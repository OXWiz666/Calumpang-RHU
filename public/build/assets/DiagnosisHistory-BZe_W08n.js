import{j as e,H as ue,L as Y,r as G}from"./app-4lbu88kA.js";import{r as n,R as ge}from"./vendor-DkBadjUr.js";import{A as ve}from"./AdminLayout-B5jylQ92.js";import{C as W,a as J,b as K,c as Q}from"./card-luqOxrG8.js";import{B as l}from"./button-BXpDG3fF.js";import{B as g}from"./badge-yHzilfWW.js";import{I as X}from"./input-N5zOrGrX.js";import{T as f}from"./textarea-CpaS5p9M.js";import{S as y,a as b,b as N,c as w,d as i}from"./select-C-0693IG.js";import{D as Z,a as ee,b as se,c as te}from"./dialog-vlGViv4z.js";import{n as S}from"./index-WHihrx3k.js";import{m as D}from"./proxy-Dc_Gbux2.js";import{A as je}from"./arrow-left-DcYYnBRL.js";import{F as fe}from"./filter-BAwJ6QQu.js";import{S as ye}from"./search-Cye_TdpF.js";import{S as L}from"./stethoscope-QcN9KdKi.js";import{F as be}from"./file-text-YZXa1D2L.js";import{P as Ne}from"./plus-MavOGQlj.js";import{C as we}from"./calendar-D9APQM2e.js";import{U as Se}from"./user-3RJR1iCA.js";import{E as De}from"./eye-mxYijkrE.js";import{S as ae}from"./square-pen-Bb1JtfBr.js";import{A as Ce,a as _e}from"./archive-BwGVl8jP.js";import{C as Pe}from"./chevron-left-B36-TXNE.js";import{C as Ae}from"./chevron-right-B3qqnx4D.js";import{P as ke}from"./printer-CfgcPaUh.js";import"./pusher-DVtoYAOu.js";import"./index-BzPzP57-.js";import"./avatar-BYPIvY84.js";import"./react-icons.esm-CCKgqiWC.js";import"./separator-DqF1LXiM.js";import"./index-MO574hLd.js";import"./index-DO3t3vkD.js";import"./moment-C5S46NFB.js";import"./label-xH30sM7L.js";import"./calendar-CoN2zrIs.js";import"./index-KF1t5bS2.js";import"./tslib.es6-M_FJ09fS.js";import"./index-Dyxvh50g.js";import"./index-BHGKAdXF.js";import"./format-Dp3w_Y3x.js";import"./isSameMonth-BOwz-_mK.js";import"./isBefore-Bnl9x5VB.js";import"./TextInput-BSQIaTF_.js";import"./createLucideIcon-BKWaAi2G.js";import"./x-b8JahagL.js";import"./settings-D_MeB5oN.js";import"./house-CSq-WFst.js";import"./users-D4PhO1-D.js";import"./pill-DIGxtF-3.js";import"./pusher-RZ9y-pSV.js";import"./package-L7rgkkVO.js";import"./circle-check-big-BQVCuGNJ.js";import"./index-CldvPdt6.js";import"./autoprefixer-Bkxp4-ve.js";import"./unit-CopbpOEH.js";import"./Toaster-D0zRMICv.js";import"./toast-C3xy5K6A.js";import"./index-DyRdtInp.js";import"./index-BWRETVzy.js";import"./use-toast-Dm0PN6fH.js";import"./layers-OK8ayVTK.js";import"./chart-column-yMaSKbSU.js";import"./index-DqxisvwK.js";function Is({diagnoses:T,patients:ie,services:Fe}){const[o,$]=n.useState(""),[x,z]=n.useState("all"),[h,R]=n.useState("all"),[p,M]=n.useState("all"),[d,H]=n.useState(1),[v]=n.useState(5),[t,C]=n.useState(null),[re,V]=n.useState(!1),[le,_]=n.useState(!1),[r,c]=n.useState({diagnosis:"",symptoms:"",treatment_plan:"",assessment:"",pertinent_findings:"",status:""}),m=T.filter(s=>{const a=o===""||s.patient_name?.toLowerCase().includes(o.toLowerCase())||s.diagnosis?.toLowerCase().includes(o.toLowerCase())||s.symptoms?.toLowerCase().includes(o.toLowerCase()),u=x==="all"||s.status===x,xe=h==="all"||s.patient_id===h;let j=!0;if(p!=="all"){const F=new Date(s.created_at),E=new Date;switch(p){case"today":j=F.toDateString()===E.toDateString();break;case"week":const he=new Date(E.getTime()-7*24*60*60*1e3);j=F>=he;break;case"month":const pe=new Date(E.getTime()-30*24*60*60*1e3);j=F>=pe;break}}return a&&u&&xe&&j}),U=Math.ceil(m.length/v),P=(d-1)*v,I=P+v,ne=m.slice(P,I);ge.useEffect(()=>{H(1)},[o,x,h,p]);const A=s=>{H(s)},oe=s=>{C(s),V(!0)},ce=s=>{C(s),c({diagnosis:s.diagnosis||"",symptoms:s.symptoms||"",treatment_plan:s.treatment_plan||"",assessment:s.assessment||s.notes||"",pertinent_findings:s.pertinent_findings||"",status:s.status||"active"}),_(!0)},O=()=>{_(!1),C(null),c({diagnosis:"",symptoms:"",treatment_plan:"",assessment:"",pertinent_findings:"",status:""})},me=s=>{s.preventDefault(),G.post(route("doctor.diagnosis.update",t.id),r,{onSuccess:()=>{S.success("Diagnosis updated successfully!"),O()},onError:a=>{console.error("Update errors:",a),S.error("Failed to update diagnosis. Please try again.")}})},q=s=>{const a=s.status==="archived"?"active":"archived";G.post(route("doctor.diagnosis.update",s.id),{status:a},{onSuccess:()=>{S.success(a==="archived"?"Diagnosis archived successfully!":"Diagnosis unarchived successfully!")},onError:u=>{console.error("Archive error:",u),S.error("Failed to update diagnosis status. Please try again.")}})},k=s=>new Date(s).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),B=s=>{switch(s){case"active":return e.jsx(g,{className:"bg-green-100 text-green-800 border-green-200",children:"Active"});case"completed":return e.jsx(g,{className:"bg-blue-100 text-blue-800 border-blue-200",children:"Completed"});case"follow_up":return e.jsx(g,{className:"bg-yellow-100 text-yellow-800 border-yellow-200",children:"Follow-up Required"});case"archived":return e.jsx(g,{className:"bg-gray-100 text-gray-800 border-gray-200",children:"Archived"});default:return e.jsx(g,{className:"bg-gray-100 text-gray-800 border-gray-200",children:"Unknown"})}},de=s=>{const a=window.open("","_blank"),u=`
            <!DOCTYPE html>
            <html>
            <head>
