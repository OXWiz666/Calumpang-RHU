  ...
  const faqs = [
    {
      ...
      answer:
        "You can schedule an appointment through our online appointment system by clicking on the 'Schedule Appointment' button on our homepage. Alternatively, you can visit the health center in person or call our appointment hotline at (083) 554-0146.",
                ...
                <Accordion type="single" collapsible className="w-full space-y-4">
                  {filteredFaqs.map((faq, index) => (
                    ...
                    >
                      <AccordionItem
                        value={`item-${index}`}
                        className="border border-gray-200 rounded-xl px-6 hover:border-teal-300 transition-colors duration-300"
                      >
                        ...
                        <AccordionContent className="pt-4 pb-6">
                          <p className="text-gray-600 leading-relaxed text-base pl-14">{faq.answer}</p>
                        </AccordionContent>
                      </AccordionItem>
                    </motion.div>
                  ))}
