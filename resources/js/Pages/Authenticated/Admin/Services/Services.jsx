    ...
    <ServicesLayout>
      <div className=" mb-5">
        ...
        <p className="text-gray-600">
          These are the services to be used in the Appointment Schedules.
        </p>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <SortableTableHead sortKey="servicename" sortable>
                        Service Name
                      </SortableTableHead>
                      <SortableTableHead sortKey="status" sortable>
                        Status
                      </SortableTableHead>
                      <SortableTableHead>Available Days</SortableTableHead>
                      <SortableTableHead sortKey="servicename" sortable>
                        Sub Services
                      </SortableTableHead>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            {service?.subservices.length <= 0 ? (
                              <div>No Sub Services</div>
                            ) : (
                              <div>
                                {service?.subservices.length} Service
                            ...
                            <div className="flex justify-end gap-2">
                              {service.status === 0 ? (
                                <Button
                                  ...
                                  onClick={() =>
                                    handleArchiveService(service.id, true)
                                  }
                                  disabled={isLoading}
                                >
                                  <svg
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    handleArchiveService(service.id, false)
                                  }
                                  disabled={isLoading}
                                >
                                  <svg
                              ...
                              >
                                ...
                                <DialogContent>
                                  <DialogHeader>
                                    <DialogTitle>
                                      Add Sub-service to {service.servicename}
                                    </DialogTitle>
                                    <DialogDescription>
                                      Create a new sub-service for this service
                                      category.
                                    </DialogDescription>
                                  </DialogHeader>
                                  <div className="grid gap-4 py-4">
                                  ...
                                  <DialogFooter>
                                    <Button
                                      ...
                                      disabled={
                                        !data.subservicename || processing
                                      }
                                    >
                                      Save Sub-service
                                    </Button>
                              ...
                              <Dialog
                                ...
                                onOpenChange={(open) => {
                                  ...
                                  if (open) {
                                    ...
                                    setDataDays("serviceid", service.id);
                                  }
                                }}
                              >
                                <DialogTrigger asChild>
                                ...
                                <DialogContent>
                                  <DialogHeader>
                                    ...
                                    <DialogDescription>
                                      Edit days for this service category.
                                    </DialogDescription>
                                  </DialogHeader>
                                  <div className="grid gap-4 py-4">
                                    <div className="grid grid-cols-4 items-center gap-4">
                                      ...
                                      {days_.map((day) => (
                                        <Badge
                                          ...
                                          onClick={() =>
                                            handleRecurrenceDateChange(day)
                                          }
                                        >
                                          {day}
                                        </Badge>
